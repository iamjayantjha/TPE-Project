...
public class WUCBottomSheet extends BottomSheetDialogFragment {
    private WUCBottomSheet.wucBottomSheetListener mListener;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        SharedPreferences preferences= requireActivity().getSharedPreferences("wucTime", MODE_PRIVATE);
        wucTime  = preferences.getString("wucTime", "0");
    ...
    public interface wucBottomSheetListener{
        void onWUCSaveClick(String text);
    }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            mListener = (WUCBottomSheet.wucBottomSheetListener) context;
        }
        catch (ClassCastException classCastException){
            throw new ClassCastException(context +" must implement Bottom Sheet Listener");
        }
